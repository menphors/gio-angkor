<div class="container-fluid" style="border-bottom: 3px solid #be1e2d; background-color: #e7e7e8;">
<div class="container">
        <div class="row">
            <div class=" title_box col-lg-3 col-md-3 col-sm-3 fa fa-bars" > CATEGORY</div>
                <nav class="nav col-sm-9 col-md-9 col-lg-9  " id="fonts">
