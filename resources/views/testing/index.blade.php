...
<div class="container-fluid  " style="background-color: #e7e7e8;">
	<div class="container ">
		<div class="row ">
			<div class="col-3  my-5 mx-auto"><img src="images/logo.png" alt="logo" class="img-thumbnail" style="width: 100px;"></div>
...
<div class="container">
  ...
  <div class="container">
        <div class="row">
            <div class="col-md-3 recolors">
                <ul class="nav">
                    <li class="">
                      <a class="" href="#"><i class="fa fa-home fa-fw"></i>Women's Clothing</a>
                    </li>
                    <li>
                  ...
                  <div class="col-md-7 well " >
                      ...
                      <div id="carouselExampleIndicators" style="right: 15px; width: 680px;"  class="carousel slide" data-ride="carousel">
                  ...
                  <div class="col-md-2 well">
                      <a class="" href="#">
                          <img src="images/170.png" width="175px" height="410px"  >
                      </a>
                  </div>
...
<div class="container" style="padding-top: 10px;">
    <div class="row ">
            <div class="no-gutters">
              <nav class="nav flex-column col-lg-3 float-left " >
                  <a class="nav-link" id="fontssa" href="#">WOMEN'S 
                    <br/>CLOTHING</a>
                  <div style="background-color: #e7e7e8; text-align: center;">
                  ...
                  <a class="nav-link"  href="#">Hair Accessories</a>
                      ...
                      <img src="images/300.png" alt="..." class="rounded float-left col-md-3" style="">
                      <img src="images/250.png" alt="..." class="rounded float-right col-md-2" style="">
                      <img src="images/400.png" alt="..." class="rounded float-right col-md-4" style="">
                      <img src="images/250.png" alt="..." class="rounded float-right col-md-2" style=""> 
                      <img src="images/250.png" alt="..." class="rounded float-right col-md-2" style="">
                      <img src="images/250.png" alt="..." class="rounded float-right col-md-2" style="">
            </div>
