    		...
    		<div class="col-lg-4 col-md-4 col-sm-4">
		    	<form class="form-inline" action="/insert" method="post">
		    		...
		    		<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="pro_name"><br><br>
				 	...
				 	<div class="form-group">  
					  <label>Model:</label>
					  <input type="text" class="form-control" id="model" name="model"><br><br>
					  <label>Price:</label>
					  <input type="text" class="form-control" id="price" name="price"><br><br>
					  <label>Color:</label>
					  <input type="text" class="form-control" id="color" name="color"><br><br>
